...
const Trends = () => {
  ...
  const avgGrowth = selectedData.reduce((sum, stat) => sum + stat.growthRate, 0) / selectedData.length;
            ...
            <ResponsiveContainer width="100%" height="100%">
              ...
              {selectedChart === 'line' && (
                <LineChart data={selectedData}>
                  ...
                  />
                  <Line type="monotone" dataKey="growthRate" stroke="#d97706" strokeWidth={3} dot={{ fill: '#d97706', strokeWidth: 2, r: 6 }} />
                </LineChart>
              )}
